...
export default function WarehouseDashboard() {
  ...
  return <>
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 12, marginBottom: 16 }}>
      <KPI label="Valore magazzino" icon="\u{1F4B6}" value={fmt(stats.valore)} accent="#F59E0B" />
      <KPI label="Sotto scorta" icon="\u{26A0}\u{FE0F}" value={stats.sottoScorta} sub="prodotti" accent="#EF4444" />
      <KPI label="Movimenti mese" icon="\u{1F4E6}" value={fmtN(stats.movimenti)} accent="#3B82F6" />
      <KPI label="Scostamento inv." icon="\u{1F4CB}" value={fmt(stats.scostamento)} sub="ultimo inventario" accent="#8B5CF6" />
    </div>
