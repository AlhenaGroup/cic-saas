...
export default function DashboardPage({ settings }) {
  ...
  return <div style={{minHeight:'100vh',background:'#0f1420',fontFamily:"'DM Sans',system-ui,sans-serif",color:'#e2e8f0'}}>
    ...
    <div style={{padding:'1.5rem',maxWidth:1400,margin:'0 auto'}}>
      ...
      {false&&(()=>{
        const [cicInvoices, setCicInvoices] = React.useState([])
        const [fatLoading, setFatLoading] = React.useState(false)
        const [localeMap, setLocaleMap] = React.useState({}) // invoiceId -> locale assegnato
        const [expandedFat, setExpandedFat] = React.useState(null)
        ...
        React.useEffect(() => { loadCicInvoices() }, [])
