...
DROP POLICY IF EXISTS "ir_s" ON public.item_rules;
...
DROP POLICY IF EXISTS "ir_i" ON public.item_rules;
...
DROP POLICY IF EXISTS "ir_u" ON public.item_rules;
...
DROP POLICY IF EXISTS "ir_d" ON public.item_rules;
...
DROP POLICY IF EXISTS "wp_i" ON public.warehouse_products;
CREATE POLICY "wp_i" ON public.warehouse_products FOR INSERT WITH CHECK (can_access(user_id, 'mag.prodotti', true));
DROP POLICY IF EXISTS "wp_u" ON public.warehouse_products;
...
DROP POLICY IF EXISTS "wp_d" ON public.warehouse_products;
...
DROP POLICY IF EXISTS "wl_d" ON public.warehouse_locations;
...
DROP POLICY IF EXISTS "ws_d" ON public.warehouse_stock;
...
DROP POLICY IF EXISTS "wm_d" ON public.warehouse_movements;
...
DROP POLICY IF EXISTS "wi_i" ON public.warehouse_invoices;
...
DROP POLICY IF EXISTS "wi_u" ON public.warehouse_invoices;
...
DROP POLICY IF EXISTS "wi_d" ON public.warehouse_invoices;
...
DROP POLICY IF EXISTS "wv_d" ON public.warehouse_inventories;
...
DROP POLICY IF EXISTS "wo_d" ON public.warehouse_orders;
...
DROP POLICY IF EXISTS "wr_d" ON public.warehouse_recipes;
...
DROP POLICY IF EXISTS "rec_d" ON public.recipes;
...
DROP POLICY IF EXISTS "drs_d" ON public.daily_report_settings;
...
DROP POLICY IF EXISTS "ar_d" ON public.alert_rules;
...
DROP POLICY IF EXISTS "ae_d" ON public.alert_events;
...
DROP POLICY IF EXISTS "aa_d" ON public.article_allergens;
...
DROP POLICY IF EXISTS "pr_d" ON public.production_recipes;
...
DROP POLICY IF EXISTS "pb_d" ON public.production_batches;
...
DROP POLICY IF EXISTS "ac_d" ON public.attendance_checklists;
...
DROP POLICY IF EXISTS "acr_d" ON public.attendance_checklist_responses;
...
DROP POLICY IF EXISTS "emp_d" ON public.employees;
...
DROP POLICY IF EXISTS "ed_d" ON public.employee_documents;
...
DROP POLICY IF EXISTS "eph_d" ON public.employee_pay_history;
...
DROP POLICY IF EXISTS "es_d" ON public.employee_shifts;
...
DROP POLICY IF EXISTS "eto_d" ON public.employee_time_off;
...
DROP POLICY IF EXISTS "ce_d" ON public.calendar_events;
...
DROP POLICY IF EXISTS "ss_d" ON public.staff_schedules;
...
DROP POLICY IF EXISTS "pc_d" ON public.personnel_costs;
...
DROP POLICY IF EXISTS "att_s" ON public.attendance;
...
DROP POLICY IF EXISTS "att_u" ON public.attendance;
...
DROP POLICY IF EXISTS "att_d" ON public.attendance;
...
DROP POLICY IF EXISTS "bp_d" ON public.budget_periods;
...
DROP POLICY IF EXISTS "bs_d" ON public.budget_scenarios;
...
DROP POLICY IF EXISTS "td_d" ON public.tag_definitions;
...
DROP POLICY IF EXISTS "cu_d" ON public.customers;
...
DROP POLICY IF EXISTS "pro_d" ON public.promotions;
...
DROP POLICY IF EXISTS "prr_d" ON public.promotion_redemptions;
...
DROP POLICY IF EXISTS "fp_d" ON public.fidelity_programs;
...
DROP POLICY IF EXISTS "fr_d" ON public.fidelity_rewards;
...
DROP POLICY IF EXISTS "fm_d" ON public.fidelity_movements;
